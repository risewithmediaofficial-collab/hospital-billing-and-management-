...
export const ROLE_NAVIGATION = {
  ...
  HOSPITAL_ADMIN: [
    ...
    { title: 'Doctors (Management)', path: '/admin/doctors-management', icon: 'Stethoscope', module: 'doctorConsultation' },
    { title: 'Nurses (Management)', path: '/admin/nurses-management', icon: 'Activity', module: 'nursing' },
    { title: 'Reception (Management)', path: '/admin/reception-management', icon: 'ConciergeBell', module: 'reception' },
    { title: 'Laboratory (Management)', path: '/admin/laboratory-management', icon: 'TestTube', module: 'laboratory' },
    { title: 'Radiology (Management)', path: '/admin/radiology-management', icon: 'Scan', module: 'radiology' },
    { title: 'Pharmacy (Management)', path: '/admin/pharmacy-management', icon: 'Pill', module: 'pharmacy' },
    { title: 'Billing (Management)', path: '/admin/billing-management', icon: 'CreditCard', module: 'billing' },
    { title: 'OPD (Management)', path: '/admin/opd-management', icon: 'ClipboardList', module: 'opd' },
    { title: 'IPD (Management)', path: '/admin/ipd-management', icon: 'BedDouble', module: 'ipd' },
    { title: 'Emergency (Management)', path: '/admin/emergency-management', icon: 'ShieldAlert', module: 'emergency' },
    { title: 'Reports & Analytics', path: '/admin/reports', icon: 'BarChart3', module: 'reports' },
    { title: 'Notifications', path: '/admin/dashboard?tab=notifications', icon: 'Bell', module: 'notifications' },
    { title: 'Audit Logs', path: '/admin/reports?tab=audit', icon: 'FileText', module: 'auditLogs' },
    { title: 'Plan Details', path: '/admin/plan-details', icon: 'BadgeCheck', module: 'dashboard' },
    { title: 'Usage & Limits', path: '/admin/usage-limits', icon: 'Gauge', module: 'dashboard' },
    { title: 'Hospital Settings', path: '/admin/tariffs', icon: 'Settings', module: 'hospitalSettings' },
  ],
  DOCTOR: [
