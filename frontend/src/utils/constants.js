...
export const ROLE_NAVIGATION = {
  ...
  PATIENT: [
    { title: 'My Health Portal', path: '/patient-portal/dashboard', icon: 'User', module: 'patientPortal' },
    { title: 'Medical Records & RX', path: '/patient-portal/records', icon: 'FileText', module: 'patientPortal' },
    { title: 'Invoices & Payments', path: '/patient-portal/bills', icon: 'Receipt', module: 'patientPortal' },
    { title: 'Request Room Amenity', path: '/patient-portal/request-amenity', icon: 'Bell', module: 'patientPortal' },
    { title: 'Emergency Console', path: '/emergency', icon: 'ShieldAlert', module: 'emergency' },
  ],
  GUARDIAN: [
    { title: 'Guardian Portal', path: '/guardian/dashboard', icon: 'Shield', module: 'guardianPortal' },
    { title: 'Patient Vitals Monitor', path: '/guardian/vitals', icon: 'HeartPulse', module: 'guardianPortal' },
    { title: 'Emergency Console', path: '/emergency', icon: 'ShieldAlert', module: 'emergency' },
  ],
};
