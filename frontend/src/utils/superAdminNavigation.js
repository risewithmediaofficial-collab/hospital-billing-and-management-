...
export const STAT_CARD_ROUTES = {
  totalHospitals: '/admin/hospitals',
  activeHospitals: '/admin/hospitals?tab=ACTIVE',
  inactiveHospitals: '/admin/hospitals?tab=EXPIRED',
  hospitalAdmins: '/admin/reports?metric=hospital-admins',
  totalStaff: '/admin/reports?metric=staff',
  doctors: '/admin/reports?metric=doctors',
  receptionists: '/admin/reports?metric=reception',
  nurses: '/admin/reports?metric=nursing',
  labStaff: '/admin/reports?metric=laboratory',
  radiologyStaff: '/admin/reports?metric=radiology',
  pharmacyStaff: '/admin/reports?metric=pharmacy',
  billingStaff: '/admin/reports?metric=billing',
  totalPatients: '/admin/reports?metric=patients',
  opdPatients: '/admin/reports?metric=patients',
